...
public enum DbEnum {
	...
	ORACLE("oracle", "", "oracle", null, "", null),
	...
	MYSQL_5("mysql_5.xx", "com.mysql.jdbc.Driver", "mysql", null, "", null),
	...
	DbEnum(String dbName,
		   ...
		   String queryStructureSql,
		   Class<? extends ConvertFactory> tClass) {
		this.dbName = dbName;
		...
		if (tClass != null) {
			try {
				...
				String msg =
					String.format("New Instance %s Error: %s", tClass.getName(), e.getMessage());
